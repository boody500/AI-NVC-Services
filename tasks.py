...
from AI_services import ensure_models_loaded, best_video_clip, compute_video_avg_embeddings, wav2lip_client, file
...
"""
@celery.task(bind=True)
def lip_sync(self,pic, summary, voice_name):
    ...
    return {"url":response["secure_url"],"id":response['asset_id'],"thumbnail":image}
"""
